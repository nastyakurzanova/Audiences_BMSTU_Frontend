                        ...
                        <div className="wrapper">
                            ...
                            <div className={"content-wrapper"}>
                                ...
                                <Routes>
                                    ...
                                    <Route path="/audiences" element={<ServicesPage />} />

                                    <Route path="/audiences/add" element={<ServiceAddPage />} />

                                    <Route path="/audiences/:id" element={<ServicePage />} />

                                    <Route path="/audiences/:id/edit" element={<ServiceEditPage />} />

                                    <Route path="/profile" element={<ProfilePage />} />

                                    <Route path="/bookings/:id" element={<OrderPage />} />
